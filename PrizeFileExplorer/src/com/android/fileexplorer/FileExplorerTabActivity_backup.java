...
public class FileExplorerTabActivity_backup extends Activity {
    ...
    public interface IBackPressedListener {
        /**
         * 婢跺嫮鎮奲ack娴滃娆㈤妴锟�        * @return True: 鐞涖劎銇氬鑼病婢跺嫮鎮� False: 濞屸剝婀佹径鍕倞閿涘矁顔�崺铏硅婢跺嫮鎮婇妴锟�        */
        boolean onBack();
    }
    ...
    public static class TabsAdapter extends FragmentPagerAdapter
        ...
        public void onTabSelected(Tab tab, FragmentTransaction ft) {
            ...
            if(!tab.getText().equals(mContext.getString(R.string.tab_sd))) {
                ActionMode actionMode = ((FileExplorerTabActivity_backup) mContext).getActionMode();
                if (actionMode != null) {
                    actionMode.finish();
                }
            }
