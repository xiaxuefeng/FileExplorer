...
public class ServerControlActivity extends Fragment implements IBackPressedListener {
    ...
    private TextView instructionText,instructionPreText;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        instructionPreText = (TextView) mRootView.findViewById(R.id.instruction_pre);
    ...
    public void updateUi() {
        ...
        instructionPreText.setVisibility(running ? View.GONE : View.VISIBLE);
    }
