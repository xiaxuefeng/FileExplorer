...
import com.android.fileexplorer.MediaFile.MediaFileType;
...
public class FileCategoryHelper {
    ...
    public static FileCategory[] sCategories = new FileCategory[] {
            FileCategory.Music, FileCategory.Video, FileCategory.Picture, FileCategory.Apk,
    ...
    private String buildSelectionByCategory(FileCategory cat) {
        ...
        switch (cat) {
            ...
            case Apk:
            	...
            	selection = "(" + FileColumns.MIME_TYPE + " == 'application/vnd.android.package-archive')";
                break;
            case Music:
            	selection = MediaStore.Audio.Media.MIME_TYPE + "= 'audio/mpeg' or "
                        + MediaStore.Audio.Media.MIME_TYPE + "= 'audio/x-ms-wma' or "
                        + MediaStore.Audio.Media.MIME_TYPE + "= 'application/ogg' or "
                        + MediaStore.Audio.Media.MIME_TYPE + "= 'audio/aac' or "
                        + MediaStore.Audio.Media.MIME_TYPE + "= 'audio/x-wav' or "
                        + MediaStore.Audio.Media.MIME_TYPE + "= 'audio/aac-adts' or "
            			+ MediaStore.Audio.Media.MIME_TYPE + "= 'audio/flac' or "
            			+ MediaStore.Audio.Media.MIME_TYPE + "= 'audio/ape'";
                break;
            default:
                selection = null;
        }
