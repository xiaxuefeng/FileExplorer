...
public class IntentBuilder {
	static String EXTRA_ALL_VIDEO_FOLDER = "mediatek.intent.extra.ALL_VIDEO_FOLDER";
    public static void viewFile(final Context context, final String filePath) {
        String type = getMimeType(filePath);
        String typeHead = type.substring(0, type.indexOf("/"));
        if (!TextUtils.isEmpty(type) && !TextUtils.equals(type, "*/*")) {
            ...
            if (typeHead.equals("image") || typeHead.equals("video")) {
            	intent.setPackage("com.android.gallery3d");
            } else if (typeHead.equals("audio")){
            	intent.setPackage("com.prize.music");
            }
            ...
            dialogBuilder.setItems(menuItemArray,
                    new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                            intent.setAction(android.content.Intent.ACTION_VIEW);
                            if (selectType.equals("image/*") || selectType.equals("video/*")) {
                            	intent.setPackage("com.android.gallery3d");
                            } else if (selectType.equals("audio/*")){
                            	intent.setPackage("com.prize.music");
                            }
	...
	public static void categoryViewFile(Context context, String filePath) {
		String type = getMimeType(filePath);
        String typeHead = type.substring(0, type.indexOf("/"));
        if (!TextUtils.isEmpty(type) && !TextUtils.equals(type, "*/*")) {
            /* 设置intent的file与MimeType */
